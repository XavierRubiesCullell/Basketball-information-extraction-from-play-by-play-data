...
BoxscoreObtentionMain(in_file = home+visiting+date+"_StandardPbP.txt", pkl1 = home+visiting+date+"_BS_"+home+".pkl", pkl2 = home+visiting+date+"_BS_"+visiting+".pkl", start="48:00", end="36:00")